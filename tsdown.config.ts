 ...
 * differing: the official channel uses the package name (`dsh-git-sidebar`)
 * and the registry channel uses the manifest id
 * (`dsh-external/dsh-git-sidebar`).
...
export default [{ entry: { index: 'src/index.ts' }, outDir: 'lib', format: ['esm'], platform: 'node', fixedExtension: false, dts: false, clean: false }, clientBundle('dsh-git-sidebar', 'client.js')] satisfies UserConfig[]
