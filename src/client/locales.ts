...
export const zh = {
  ...
  branchDeleteLocalDesc: '将删除本地分支：{names}。未合并的分支会被 Git 拒绝。',
  branchDeleteForceDesc: '将强制删除本地分支：{names}。其中未合并的提交可能无法找回。',
  branchDeleteRemoteTitle: '删除远程分支',
  branchDeleteRemoteDesc: '将从远端删除分支：{names}。删除后其他人也会看到它们消失。',
...
export const en = {
  ...
  branchDeleteLocalDesc: 'Deletes the local branches: {names}. Git refuses unmerged ones.',
  branchDeleteForceDesc: 'Force-deletes the local branches: {names}. Unmerged commits may be unrecoverable.',
  branchDeleteRemoteTitle: 'Delete remote branches',
  branchDeleteRemoteDesc: 'Deletes the branches on the remote: {names}. Everyone else will see them disappear.',
